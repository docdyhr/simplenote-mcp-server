...
def generate_random_text(min_words=50, max_words=200):
    ...
    keywords = ["project", "meeting", "report", "important", "todo", "deadline", "client"]
...
def large_note_collection():
    ...
    for i in range(500):
        ...
        # Select random tags
        all_tags = ["work", "personal", "project", "meeting", "important", "todo", "idea"]
...
class TestSearchPerformance:
    ...
    def test_boolean_search_performance(self, large_note_collection):
        ...
        start_time = time.time()
        results = engine.search(large_note_collection, "project AND meeting AND NOT todo")
        end_time = time.time()
    ...
    def test_tag_filter_performance(self, large_note_collection):
        ...
        start_time = time.time()
        results = engine.search(large_note_collection, "", tag_filters=["work", "important"])
        end_time = time.time()
...
class TestSearchStress:
    ...
    def test_very_large_note_search(self, very_large_note):
        ...
        start_time = time.time()
        results = engine.search(very_large_note, "project")
        end_time = time.time()
    ...
    def test_many_small_notes_search(self, many_small_notes):
        ...
        start_time = time.time()
        results = engine.search(many_small_notes, "project")
        end_time = time.time()
        ...
        # Assert the search completes in a reasonable time
        assert elapsed_time < 1.0, "Search across many notes should complete in reasonable time"
    ...
    def test_complex_query_on_many_notes(self, many_small_notes):
        ...
        # Assert the search completes in a reasonable time
        assert elapsed_time < 1.5, "Complex search on many notes should complete in reasonable time"